...
import { noteMetaSchema, noteTopicSchema } from '../schema';
        ...
        messages: [
            ...
            },
            {
                ...
                content: [
                    { 
                        type: "text",
                        text: `Use the provided documents as sources for generation. Use the following instructions to guide your topic generation: ${context.instructions}`
                    },
                    ...files
                ]
            }
