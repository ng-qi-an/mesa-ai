...
export default function QuizActionsDropdown({quiz, triggerClassName, onRename, onDelete}:{quiz: QuizSelect, triggerClassName?: string, onRename: (newName: string) => void, onDelete: () => void}) {
    ...
    <RenameChatDialog open={showRenameDialog} setOpen={setShowRenameDialog} chatid={quiz.id} initialName={quiz.name} onSubmit={onRename}/>
    <DeleteChatDialog chatId={quiz.id} open={showDeleteDialog} onOpenChange={setShowDeleteDialog} onSubmit={onDelete}/>
</div>
}