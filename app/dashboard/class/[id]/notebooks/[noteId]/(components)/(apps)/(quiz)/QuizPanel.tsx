...
export default function QuizPanel({setSidebarTool}: {setSidebarTool: (tool: string) => void}){
    ...
    if (selectedQuizId == "create") {
        ...
        return <QuizQuestionsPanel quiz={activeQuiz} setSelectedQuizId={setSelectedQuizId}/>;
    } else {
